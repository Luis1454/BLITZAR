...
int main(void)
{
    ...
    if (blitzar_simulation_set_particles(simulation, 2, position_x, position_y, position_z,
            velocity_x, velocity_y, velocity_z, mass) != BLITZAR_STATUS_OK ||
    ...
    if (blitzar_simulation_get_state(simulation, 2, output_x, output_y, output_z, output_velocity_x,
