...
inline constexpr std::uint32_t kFrontendRemoteTimeoutMinMs = 10u;
inline constexpr std::uint32_t kFrontendRemoteTimeoutMaxMs = 60000u;
inline constexpr std::uint32_t kFrontendRemoteCommandTimeoutMsDefault = 80u;
inline constexpr std::uint32_t kFrontendRemoteStatusTimeoutMsDefault = 40u;
inline constexpr std::uint32_t kFrontendRemoteSnapshotTimeoutMsDefault = 140u;
...
class FrontendBackendBridge {
    public:
        using LocalBackendFactory = std::function<std::unique_ptr<ILocalBackend>(const std::string &)>;
