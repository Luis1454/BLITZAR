...
BLITZAR_API blitzar_status blitzar_simulation_set_barnes_hut(
    blitzar_simulation* simulation,
...
BLITZAR_API blitzar_status blitzar_simulation_set_particles(
    blitzar_simulation* simulation,
    int64_t particle_count,
...
BLITZAR_API blitzar_status blitzar_simulation_get_state(
    const blitzar_simulation* simulation,
    int64_t capacity,
    double* position_x,
    double* position_y,
...
BLITZAR_API blitzar_status blitzar_simulation_step(
    blitzar_simulation* simulation);
