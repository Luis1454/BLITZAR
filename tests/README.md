...
- `tests/checks/check.py`: unified entrypoint for repo checks, PR gates, and `clang-tidy`.
...
- Static analyzer: `python tests/checks/check.py clang_tidy --root . --build-dir build-quality`
