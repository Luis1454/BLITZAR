...
bool AdvanceSimulation(blitzar_sim::Simulation& simulation, int step_count) noexcept
{
...
bool ValidateRejectedInput(blitzar_sim::Simulation& simulation, const StateArrays& initial,
    const StateArrays& reference) noexcept
{
...
bool Configure(blitzar_sim::Simulation& simulation, const StateArrays& state, double timestep,
