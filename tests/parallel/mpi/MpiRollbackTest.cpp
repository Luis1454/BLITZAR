...
bool ConfigureRollback(blitzar_sim::Simulation& simulation, const StateArrays& initial) noexcept
{
...
bool PrepareRollbackPair(blitzar_sim::Simulation& simulation, blitzar_sim::Simulation& expected,
...
bool TriggerRollbackFailure(
    blitzar_sim::Simulation& simulation, StateArrays& before_failure) noexcept
{
...
bool ValidateRollbackRetry(
    blitzar_sim::Simulation& simulation, blitzar_sim::Simulation& expected) noexcept
{
...
bool RunRollbackCase() noexcept
{
    ...
    blitzar_sim::Simulation simulation(ParticleCount);
    blitzar_sim::Simulation expected(ParticleCount);
