...
int main()
{
    ...
    blitzar_integration_kdk::AdvanceState free_state{
        free_particle, free_acceleration, free_workspace, solver, 0.5, settings, solver_workspace,
        free_particle.State()};
    ...
    blitzar_integration_kdk::AdvanceState rollback_state{
        rollback_particle, rollback_acceleration, rollback_workspace, failing_solver, 0.5,
        settings, solver_workspace, rollback_particle.State()};
    ...
    blitzar_integration_kdk::AdvanceState external_state{
        external_rollback_particle, external_rollback_acceleration, external_rollback_workspace,
        external_failing_solver, 0.5, settings, external_solver_workspace,
    ...
    blitzar_integration_kdk::AdvanceState non_finite_state{
        non_finite_particle, non_finite_acceleration, non_finite_workspace, non_finite_solver, 0.5,
        settings, solver_workspace, non_finite_particle.State()};
