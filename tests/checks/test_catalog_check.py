...
class TestCatalogCommand(BaseCliCommand):
    def build_parser(self) -> argparse.ArgumentParser:
        parser = argparse.ArgumentParser(description="Validate normalized test catalog.")
    ...
    def build_check(self, args: argparse.Namespace) -> BaseCheck:
        del args
        return TestCatalogCheck()


def main() -> int:
    return TestCatalogCommand().main()
