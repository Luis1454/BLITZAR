...
#include "simulation/tx/SimRollback.hpp"
#include "simulation/tx/SimTransaction.hpp"
...
static_assert(std::is_aggregate_v<blitzar_sim::SimTransactionState>);
...
int main()
{
    ...
    blitzar_particles::ParticleSourceBuffer source(1);
    ...
    blitzar_particles::ParticleAccelerationBuffer acceleration_buffer(arena);
    ...
    const blitzar_sim::SimTransactionState transaction_state{arena, particle_buffer,
