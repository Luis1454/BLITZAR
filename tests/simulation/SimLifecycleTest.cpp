...
int main()
{
    ...
    BLITZAR_CHECK(simulation.set_solver(blitzar::SolverKind::Kifmm) == blitzar::Status::Ok);
    BLITZAR_CHECK(
        simulation.set_integrator(blitzar::IntegratorKind::KdkLeapfrog) == blitzar::Status::Ok);
