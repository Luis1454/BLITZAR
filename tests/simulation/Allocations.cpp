...
[[nodiscard]] bool Configure(blitzar_sim::Simulation& simulation, const StateArrays& state,
...
[[nodiscard]] bool RunCase(blitzar_sim::Simulation& simulation, blitzar_solver_kind solver) noexcept
{
