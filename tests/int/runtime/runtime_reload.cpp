...
TEST(ClientRuntimeTest, TST_CNT_RUNT_008_LoadResetInvalidatesClientSnapshotCacheUntilReloaded)
{
    ...
    const std::filesystem::path xyz3 = writeTempXyz("grav_test_client_reload_3.xyz", {-2.0f, 0.0f, 2.0f});
    const std::filesystem::path xyz4 = writeTempXyz("grav_test_client_reload_4.xyz", {-3.0f, -1.0f, 1.0f, 3.0f});
