...
bool AdvanceSimulation(blitzar_sdk::Simulation& simulation, int step_count) noexcept
{
...
bool ValidateRejectedInput(blitzar_sdk::Simulation& simulation, const StateArrays& initial,
...
bool Configure(blitzar_sdk::Simulation& simulation, const StateArrays& state, double timestep,
