...
bool BeginInvalidGhostExchange(FixtureProtocol& fixture,
...
bool ValidateInvalidMigration(FixtureProtocol& fixture, blitzar_core::ParticleStateView local_state,
...
bool ValidateEscapedMigration(FixtureProtocol& fixture) noexcept
{
    blitzar_particles::ParticleBuffer escaped(1);
    const blitzar_parallel::MpiDomainBounds bounds = fixture.domain.GlobalBounds();
...
bool ValidateInvalidGhostExchange(FixtureProtocol& fixture) noexcept
{
