...
bool ValidateUnpreparedGhostExchange(FixtureProtocol& fixture) noexcept
{
    ...
    if (fixture.exchange.BeginGhosts(fixture.particles.State(), fixture.ids, unprepared_exchange) !=
        ...
        fixture.context.IsCommunicationActive(unprepared_exchange)) {
        return false;
    }
...
bool PrepareGhostExchange(
    FixtureProtocol& fixture, blitzar_parallel::MpiContext::GhostExchange& exchange) noexcept
{
    ...
    if (fixture.context.IsCommunicationActive(exchange) != fixture.context.IsDistributed()) {
        return false;
    }
...
bool ValidateRecoveredGhostExchange(FixtureProtocol& fixture) noexcept
{
...
bool ValidateInitialGhostExchange(FixtureProtocol& fixture) noexcept
{
...
bool ValidateMovedGhostExchange(FixtureProtocol& fixture) noexcept
{
...
bool ValidateUninitializedMigration(FixtureProtocol& fixture) noexcept
{
    blitzar_parallel::MpiDomainDecomposition uninitialized_domain;
...
bool RunErrorSynchronizationCase(blitzar_parallel::MpiContext& context) noexcept
{
    ...
    FixtureProtocol fixture(context);
