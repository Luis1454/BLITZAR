...
bool ConfigureOverlap(
    blitzar_sim::Sim& overlapped, blitzar_sim::Sim& serialized, const StateArrays& initial) noexcept
{
...
bool AdvanceOverlap(blitzar_sim::Sim& overlapped, blitzar_sim::Sim& serialized) noexcept
{
...
bool CaptureOverlapState(blitzar_sim::Sim& overlapped, blitzar_sim::Sim& serialized,
...
bool CaptureSteadyState(blitzar_sim::Sim& overlapped, blitzar_sim::Sim& serialized,
    OverlapObservation& observation) noexcept
{
...
bool RunOverlapCase(blitzar_parallel::MpiContext& context) noexcept
{
    ...
    blitzar_sim::Sim overlapped(ParticleCount);
    blitzar_sim::Sim serialized(ParticleCount);
