...
bool CheckIncludedBoundaryPoints(const blitzar_parallel::MpiDomainDecomposition& domain,
...
bool CheckExcludedBoundaryPoints(const blitzar_parallel::MpiDomainDecomposition& domain,
...
std::array<blitzar_core::Vector3, 8> MakeCorners(blitzar_parallel::MpiDomainBounds bounds) noexcept
{
...
std::array<blitzar_core::Vector3, 6> MakeOutsideFaces(
    blitzar_parallel::MpiDomainBounds bounds, blitzar_core::Vector3 middle) noexcept
{
...
std::array<blitzar_core::Vector3, 8> MakeOutsideCorners(
    blitzar_parallel::MpiDomainBounds bounds) noexcept
{
    const double negative_infinity = -std::numeric_limits<double>::infinity();
    const double positive_infinity = std::numeric_limits<double>::infinity();
    std::array<blitzar_core::Vector3, 8> corners{};
...
bool RunBoundaryOwnershipCase(blitzar_parallel::MpiContext& context) noexcept
{
    ...
    const blitzar_parallel::MpiDomainBounds bounds = domain.GlobalBounds();
