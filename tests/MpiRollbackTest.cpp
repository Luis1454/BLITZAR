...
bool ConfigureRollback(blitzar_sdk::Simulation& simulation, const StateArrays& initial) noexcept
{
...
bool PrepareRollbackPair(blitzar_sdk::Simulation& simulation, blitzar_sdk::Simulation& expected,
...
bool TriggerRollbackFailure(
    blitzar_sdk::Simulation& simulation, StateArrays& before_failure) noexcept
{
...
bool ValidateRollbackRetry(
    blitzar_sdk::Simulation& simulation, blitzar_sdk::Simulation& expected) noexcept
{
