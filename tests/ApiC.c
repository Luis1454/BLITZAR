...
int main(void)
{
    ...
    BLITZAR_CHECK(
        blitzar_simulation_get_state(simulation, 1, output_x, output_y, output_z, output_velocity_x,
            output_velocity_y, output_velocity_z, output_mass) == BLITZAR_STATUS_INVALID_ARGUMENT);
