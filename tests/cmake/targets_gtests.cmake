...
if(WIN32)
    ...
    set(BLITZAR_TEST_ENV_UTILS_SOURCES
        "${BLITZAR_ROOT_DIR}/engine/config/env/src/env/Base.cpp"
        "${BLITZAR_ROOT_DIR}/engine/config/env/src/env/Win.cpp"
    )
else()
    set(BLITZAR_TEST_SCOPED_ENV_VAR_SOURCE "${BLITZAR_ROOT_DIR}/tests/support/scoped_env_var_posix.cpp")
    set(BLITZAR_TEST_ENV_UTILS_SOURCES
        "${BLITZAR_ROOT_DIR}/engine/config/env/src/env/Base.cpp"
        "${BLITZAR_ROOT_DIR}/engine/config/env/src/env/Posix.cpp"
    )
endif()
...
if(BLITZAR_TEST_UNIT_CONFIG_SOURCES)
    BLITZAR_add_gtest(blitzarConfigArgsGTests
        ...
        SOURCES
            ...
            "${BLITZAR_ROOT_DIR}/engine/config/args/src/args/Main.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/args/src/args/Parse.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/args/src/args/CoreOptions.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/args/src/args/ClientOptions.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/args/src/args/InitOptions.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/args/src/args/InitStateOptions.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/args/src/args/FluidOptions.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/registry/src/registry/Main.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/registry/src/registry/Apply.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/registry/src/registry/ApplyScalar.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/registry/src/registry/ApplyNormalized.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/registry/src/registry/Entries.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/registry/src/registry/EntriesCore.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/registry/src/registry/EntriesClient.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/registry/src/registry/EntriesInitState.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/registry/src/registry/EntriesFluid.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/profile/src/profile/Performance.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/profile/src/profile/Main.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/validation/src/validation/Scenario.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/validation/src/validation/ScenarioScene.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/validation/src/validation/ScenarioRuntime.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/validation/src/validation/ScenarioInitialState.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/validation/src/validation/ScenarioCosmology.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/validation/src/validation/Physics.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/validation/src/validation/Render.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/directive/src/directive/Config.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/directive/src/directive/Options.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/directive/src/directive/Parser.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/directive/src/directive/Scene.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/directive/src/directive/LegacyScene.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/directive/src/directive/Write.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/directive/src/directive/CfgCore.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/directive/src/directive/InitialState.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/directive/src/directive/SceneWriter.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/directive/src/directive/StreamWriter.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/directive/src/directive/ValueFormatter.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/core/src/core/Config.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/modes/src/modes/Normalize.cpp"
            "${BLITZAR_ROOT_DIR}/engine/server/src/SimulationInitConfig.cpp"
            "${BLITZAR_ROOT_DIR}/engine/config/text/src/text/Parse.cpp"
    )
endif()
