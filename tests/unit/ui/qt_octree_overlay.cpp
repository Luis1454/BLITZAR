...
TEST(QtUiLogicTest, TST_UNT_UI_009_OctreeOverlayBuildRespectsDepthLimit)
{
    ...
    const std::vector<grav_qt::OctreeOverlayNode> depthZero = grav_qt::OctreeOverlay::build(particles, 0);
    const std::vector<grav_qt::OctreeOverlayNode> depthOne = grav_qt::OctreeOverlay::build(particles, 1);
