...
| FMEA-002 | Backend protocol status contract regression | Medium | `protocol-maintainer` | `in-progress` | `#120`, `#101`, `#98` | `EVD_TEST_INT_PROTOCOL_CONNECT`, `EVD_QLT_INTERFACE_CONTRACTS` |
| FMEA-003 | Unauthorized control command accepted | Medium | `security-maintainer` | `closed` | `#101` | `EVD_TEST_INT_PROTOCOL_CONTROL` |
| FMEA-004 | Runtime fails to reconnect after backend restart | Medium | `runtime-maintainer` | `in-progress` | `#120` | `EVD_TEST_INT_RUNTIME_BRIDGE`, `EVD_TEST_INT_RUNTIME_RUNTIME` |
