...
- C++/CUDA/Python decomposition is governed by function/method length, function count, and lightweight branching complexity. Line thresholds are informational only for documentation, configuration, and build metadata.
