...
Percentages are shown directly in the run summary (`Hosted coverage percentages` section) as a table (Lines/Functions/Branches), and also as a workflow notice.
