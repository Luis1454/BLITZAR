...
Percentages are shown at the top of this README (auto-updated dashboard table with mini graphs), in the run summary (`Hosted coverage percentages`), and as a workflow notice.
