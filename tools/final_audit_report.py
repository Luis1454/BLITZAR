...
from final_audit_contract import commit_exists, git_output, load_json
from final_audit_scan import audit_files, structural_summary, workspace_summary
...
def build_audit(
    ...
    from final_audit_contract import validate_contract
    ...
    if run_gates:
        gate = run_command(
            root,
            "python tools/quality_gate.py --root . --group static",
            600,
            "static-quality",
        )
