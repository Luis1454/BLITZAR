...
from tools.audit.final_audit_contract import commit_exists, git_output, load_json
from tools.audit.final_audit_scan import audit_files, structural_summary, workspace_summary
...
def build_audit(
    ...
    from tools.audit.final_audit_contract import validate_contract
