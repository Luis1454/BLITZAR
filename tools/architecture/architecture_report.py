...
from tools.gates.argument_gate import load_exceptions
from tools.architecture.architecture_metrics import (
    FileMetric,
    FunctionMetric,
    dependency_names,
    scan_file_functions,
...
from tools.architecture.architecture_scope import (
    SOURCE_ROOTS,
    classify_path,
    discover_files,
