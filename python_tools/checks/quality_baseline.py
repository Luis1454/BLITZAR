...
from python_tools.checks.deviation_register import DeviationRegister
from python_tools.checks.evidence_registry import resolve_evidence_ref
from python_tools.checks.quality_manifest import CROSSWALK_KEY, QUALITY_MANIFEST_PATH, REQUIREMENTS_KEY, QualityManifestLoader
from python_tools.checks.repo_policy_support import load_allowlist
...
class QualityBaselineCheck(BaseCheck):
    ...
    def _load_requirements(self, manifest: dict[str, JsonValue], result: CheckResult) -> dict[str, list[str]]:
