...
if(GRAVITY_BUILD_CLIENT_MODULES)
    ...
    if(NOT Qt6_FOUND AND WIN32)
        if(DEFINED ENV{QT_DIR})
            file(GLOB _qt_local_roots "$ENV{QT_DIR}/*/msvc*_64")
        else()
            file(GLOB _qt_local_roots "$ENV{SystemDrive}/Qt/*/msvc*_64")
        endif()
    ...
    if(TARGET Qt6::Widgets)
        ...
        target_link_libraries(${CLIENT_MODULE_QT_INPROC_NAME} PRIVATE gravityRustRuntime Qt6::Widgets)
