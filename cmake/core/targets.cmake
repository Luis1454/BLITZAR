...
function(configure_gravity_cpp_target target_name)
    ...
    if(GRAVITY_PROFILE STREQUAL "prod")
        target_compile_definitions(${target_name} PRIVATE GRAVITY_PROFILE_PROD=1 GRAVITY_PROFILE_IS_PROD=1 GRAVITY_PROFILE_IS_DEV=0)
    else()
        target_compile_definitions(${target_name} PRIVATE GRAVITY_PROFILE_DEV=1 GRAVITY_PROFILE_IS_PROD=0 GRAVITY_PROFILE_IS_DEV=1)
    endif()
endfunction()
