...
int main(int argc, char** argv)
{
    ...
    std::cout << "[headless] done particles=" << finalStats.particleCount
              ...
              << " dt=" << finalStats.dt << " solver=" << finalStats.solverName
              << " time_ms=" << elapsedMs << " Ekin=" << finalStats.kineticEnergy
              << " Epot=" << finalStats.potentialEnergy << " Eth=" << finalStats.thermalEnergy
              << " Erad=" << finalStats.radiatedEnergy << " Etot=" << finalStats.totalEnergy
