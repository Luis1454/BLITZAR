/*
 * @file modules/qt/src/support/theme/GuiTheme.cpp
 * @author Luis1454
 * @project BLITZAR
...
namespace bltzr_qt {
ThemeMode Theme::resolve(const std::string& themeName)
{
    return themeName == "dark" ? ThemeMode::Dark : ThemeMode::Light;
}

std::string Theme::toConfigValue(ThemeMode mode)
{
    return mode == ThemeMode::Dark ? "dark" : "light";
}

QPalette Theme::buildPalette(ThemeMode mode)
{
    QPalette palette;
