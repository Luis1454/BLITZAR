/*
 * @file modules/qt/src/widgets/graphs/GuiGraph.hpp
 * @author Luis1454
 * @project BLITZAR
 * @brief Qt desktop user interface module for simulation control and visualization.
 */

#ifndef BLITZAR_MODULES_QT_SRC_WIDGETS_GRAPHS_GRAPH_HPP_
#define BLITZAR_MODULES_QT_SRC_WIDGETS_GRAPHS_GRAPH_HPP_
/*
 * Module: qt
 * Responsibility: Render the recent energy history exposed by the client runtime.
 */
#include "src/support/geometry/GuiViewMath.hpp"
#include <QStringList>
#include <QWidget>
#include <vector>
/*
...
#endif // BLITZAR_MODULES_QT_SRC_WIDGETS_GRAPHS_GRAPH_HPP_
