    ...
    public:
        static QString lightStyleSheet()
        {
            return
                ...
                "QLineEdit, QComboBox, QDoubleSpinBox, QSpinBox { background: #ffffff; color: #102a43; border: 1px solid #b9c7d8; border-radius: 7px; padding: 4px 6px; }"
                "QLineEdit:disabled, QComboBox:disabled, QDoubleSpinBox:disabled, QSpinBox:disabled { background: #f1f5f9; color: #7b8794; border-color: #d9e2ec; }"
                ...
                "QTabWidget#workspaceSidebarTabs QTabBar::tab { background: #d7e1ed; color: #486581; border-radius: 8px; padding: 10px 10px; margin: 2px; font-weight: 600; min-width: 58px; min-height: 58px; }"
                "QTabWidget#workspaceSidebarTabs QTabBar::tab:selected { background: #ffffff; color: #102a43; font-weight: 700; }"
                "QStatusBar { background: #f8fafc; border-top: 1px solid #d9e2ec; color: #486581; }"
                "QWidget#telemetrySummaryPane QFrame#runtimeCard { border: 1px solid #d7dee6; border-radius: 8px; background: #f7f9fb; }"
                "QWidget#telemetrySummaryPane QLabel#runtimeCardTitle { color: #486581; font-size: 11px; font-weight: 700; text-transform: uppercase; }"
        ...
        static QString darkStyleSheet()
        {
            return
                ...
                "QDockWidget::title { background: #1a273a; color: #f0f4f8; padding: 7px 10px; font-weight: 700; }"
                "QGroupBox { border: 1px solid #2a3b52; border-radius: 10px; margin-top: 10px; padding-top: 10px; background: #162133; }"
                "QGroupBox::title { subcontrol-origin: margin; left: 10px; padding: 0 4px; color: #cdd8e5; font-weight: 700; }"
                "QPushButton { background: #2b6cb0; color: #f8fbff; border: 1px solid #215285; border-radius: 8px; padding: 7px 10px; min-height: 18px; font-weight: 700; }"
                ...
                "QPushButton:disabled { background: #223043; color: #7b8794; border: 1px solid #304156; }"
                "QLineEdit, QComboBox, QDoubleSpinBox, QSpinBox { background: #0f1724; color: #e5edf5; border: 1px solid #39506d; border-radius: 7px; padding: 4px 6px; }"
                "QLineEdit:disabled, QComboBox:disabled, QDoubleSpinBox:disabled, QSpinBox:disabled { background: #172131; color: #7b8794; border-color: #243447; }"
                "QComboBox QAbstractItemView { color: #e5edf5; background: #182436; selection-background-color: #2b4363; }"
                "QLabel { color: #d9e2ec; }"
                "QLabel#validationLabel { color: #ff8c8c; }"
                "QCheckBox { color: #d9e2ec; spacing: 6px; }"
                "QCheckBox::indicator { width: 16px; height: 16px; border-radius: 4px; border: 1px solid #5a708a; background: #101826; }"
                "QCheckBox::indicator:checked { background: #2b6cb0; border-color: #215285; image: none; }"
                "QCheckBox::indicator:unchecked:hover, QCheckBox::indicator:checked:hover { border-color: #5da0ff; }"
                "QTabWidget::pane { border: 0; }"
                "QTabWidget#workspaceSidebarTabs QTabBar::tab { background: #223247; color: #9fb3c8; border-radius: 8px; padding: 10px 10px; margin: 2px; font-weight: 600; min-width: 58px; min-height: 58px; }"
                "QTabWidget#workspaceSidebarTabs QTabBar::tab:selected { background: #101826; color: #f0f4f8; font-weight: 700; }"
                "QStatusBar { background: #162133; border-top: 1px solid #243447; color: #9fb3c8; }"
                "QWidget#telemetrySummaryPane QFrame#runtimeCard { border: 1px solid #2a3b52; border-radius: 8px; background: #162133; }"
                "QWidget#telemetrySummaryPane QLabel#runtimeCardTitle { color: #8ea2b8; font-size: 11px; font-weight: 700; text-transform: uppercase; }"
...
{
    return mode == QtThemeMode::Dark
        ? QtThemeLocal::darkStyleSheet()
