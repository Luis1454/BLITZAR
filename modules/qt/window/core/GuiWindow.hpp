...
private:
    ...
    void buildMenus();
    void buildFileMenu(QPointer<QMenu> menu);
    void buildEditMenu(QPointer<QMenu> menu);
    void buildViewMenu(QPointer<QMenu> menu);
    void buildSimulationMenu(QPointer<QMenu> menu);
    void buildWindowMenu(QPointer<QMenu> menu);
    void buildHelpMenu(QPointer<QMenu> menu);
    void buildThemeMenu(QPointer<QMenu> menu);
    ...
    void connectRunControls();
    void connectSceneControls();
    void connectPhysicsControls();
    void connectSphControls();
    void connectSolverControls();
    void connectTreePmControls();
    void connectAdaptiveControls();
    void connectOctreeControls();
    void connectRenderControls();
    void applySphParameters();
    void applyTreePmParameters();
    void updateTreePmAvailability();
    void updateIntegratorAvailability();
