...
/// Description: Executes the blitzar_runtime_bridge_link_state_label operation.
blitzar_runtime_bridge_link_state_label(const blitzar_runtime_bridge_t* state);
blitzar_runtime_string_view
/// Description: Executes the blitzar_runtime_bridge_server_owner_label operation.
