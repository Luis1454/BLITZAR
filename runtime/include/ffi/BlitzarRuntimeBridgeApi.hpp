...
std::uint32_t blitzar_runtime_bridge_set_snapshot_cap(blitzar_runtime_bridge_t *state, std::uint32_t requested);
...
bool blitzar_runtime_bridge_queue_pending_command(
    blitzar_runtime_bridge_t *state,
...
bool blitzar_runtime_bridge_pending_command_view(
    const blitzar_runtime_bridge_t *state,
    std::size_t index,
...
blitzar_runtime_string_view blitzar_runtime_bridge_link_state_label(const blitzar_runtime_bridge_t *state);
blitzar_runtime_string_view blitzar_runtime_bridge_server_owner_label(const blitzar_runtime_bridge_t *state);
