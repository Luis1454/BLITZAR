...
blitzar_core_result_t blitzar_core_apply_config(
    blitzar_core_t *core,
    const blitzar_core_config_t *config);
blitzar_core_result_t blitzar_core_run_steps(
    blitzar_core_t *core,
    uint32_t steps,
    uint32_t timeout_ms);
blitzar_core_result_t blitzar_core_get_status(
...
blitzar_core_result_t blitzar_core_export_state(
    ...
    const char *format,
    uint32_t timeout_ms);
size_t blitzar_core_get_last_error(
    const blitzar_core_t *core,
    char *error_buffer,
    size_t error_buffer_capacity);
