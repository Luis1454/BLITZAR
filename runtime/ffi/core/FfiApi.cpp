/*
 * @file runtime/ffi/core/FfiApi.cpp
 * @author Luis1454
 * @project BLITZAR
...
{
    return blitzar_core_config_t{
        10000u,             // particle_count
        0.01f,              // dt
        "pairwise_cuda",    // solver_name
        "euler",            // integrator_name
        "interactive",      // performance_profile
        0.01f,              // substep_target_dt
        4u,                 // max_substeps
        50u                 // snapshot_publish_period_ms
    };
}
...
{
    if (core == nullptr) {
        bltzr_ffi_internal::writeErrorMessage("core is required", error_buffer, error_buffer_capacity);
