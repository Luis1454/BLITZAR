/*
 * @file runtime/server/core/SrvDaemon.hpp
 * @author Luis1454
 * @project BLITZAR
...
public:
     ...
     * it.
     */
    explicit Daemon(SimulationServer& server, std::string authToken = {});
    /*
     * @brief Documents the ~server daemon operation contract.
     * @param None This contract does not take explicit parameters.
     * @return No return value.
     ...
     * it.
     */
    bool start(std::uint16_t port, const std::string& bindAddress = kDefaultLoopbackHost);
    /*
