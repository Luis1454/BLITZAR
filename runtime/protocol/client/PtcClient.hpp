/*
 * @file runtime/protocol/client/PtcClient.hpp
 * @author Luis1454
 * @project BLITZAR
...
public:
     ...
     * @return Response value produced by this contract.
     * @note Keep side effects explicit and preserve deterministic behavior where callers depend on
     * it.
     */
    Response sendJson(const std::string& jsonLine);
    /*
     ...
     * it.
     */
    Response sendCommand(const std::string& cmd, const std::string& fieldsJson = "");
    /*
     ...
     * it.
     */
    Response getStatus(ClientStatus& outStatus);
    /*
