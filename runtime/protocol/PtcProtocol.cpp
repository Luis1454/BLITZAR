/*
 * @file runtime/protocol/PtcProtocol.cpp
 * @author Luis1454
 * @project BLITZAR
...
const std::string_view SetTreePmAssignment = "set_treepm_assignment";
const std::string_view SetTreePmParameters = "set_treepm_parameters";
const std::string_view SetAdaptiveTimeSteps = "set_adaptive_time_steps";
const std::string_view SetAdaptiveTimeStepCostGuard = "set_adaptive_cost_guard";
...
const std::string_view SetInitialStateConfig = "set_initial_state_config";
