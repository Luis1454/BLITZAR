/*
 * @file engine/physics/core/particle/PhyParticleHotData.cpp
 * @author Luis1454
 * @project BLITZAR
 * @brief Cache-optimized particle data packing helpers for the physics hotpath.
 */

#include "physics/core/particle/PhyParticleHotData.hpp"
#include "physics/core/particle/PhyParticle.hpp"
