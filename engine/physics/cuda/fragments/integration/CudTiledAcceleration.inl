/*
 * @file engine/physics/cuda/fragments/integration/CudTiledAcceleration.inl
 * @author Luis1454
 * @project BLITZAR
 ...
 * @note Keep side effects explicit and preserve deterministic behavior where callers depend on it.
 */
__global__ __launch_bounds__(128, 2) void computePairwiseAccelerationKernelTiled(ParticleSoAView state,
                                                       ...
                                                       float maxAcceleration)
{
    ...
    Vector3 totalForce = {0.0f, 0.0f, 0.0f};
        ...
        // Reduce tile size to improve occupancy and reduce shared-memory pressure
 ...
 * @note Keep side effects explicit and preserve deterministic behavior where callers depend on it.
 */
__global__ __launch_bounds__(128, 2) void computePairwiseAccelerationKernelWarpReduced(ParticleSoAView state,
                                                             Vector3Handle outAcceleration,
                                                             int numParticles,
