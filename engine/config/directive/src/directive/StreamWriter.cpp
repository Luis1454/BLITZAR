/*
 * @file engine/config/directive/src/directive/StreamWriter.cpp
 * @author Luis1454
 * @project BLITZAR
 * @brief Configuration parsing, validation, and serialization implementation.
 */

#include "directive/StreamWriter.hpp"
#include "directive/ValueFormatter.hpp"
#include <ostream>
...
{
    writeKey(key);
    _out << quoteDirectiveValue(value);
}
