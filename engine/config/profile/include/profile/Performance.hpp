/*
 * @file engine/config/profile/include/profile/Performance.hpp
 * @author Luis1454
 * @project BLITZAR
 * @brief Public configuration interfaces and validation contracts for simulation setup.
 */

#ifndef BLITZAR_ENGINE_INCLUDE_CONFIG_SIMULATIONPERFORMANCEPROFILE_HPP_
#define BLITZAR_ENGINE_INCLUDE_CONFIG_SIMULATIONPERFORMANCEPROFILE_HPP_
#include <string>
#include <string_view>
/*
