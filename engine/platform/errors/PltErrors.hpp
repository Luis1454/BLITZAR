/*
 * @file engine/platform/errors/PltErrors.hpp
 * @author Luis1454
 * @project BLITZAR
 * @brief Platform abstraction interfaces for portable runtime services.
 */

#ifndef BLITZAR_ENGINE_INCLUDE_PLATFORM_ERRORS_HPP_
#define BLITZAR_ENGINE_INCLUDE_PLATFORM_ERRORS_HPP_
#include <string_view>
...
#endif // BLITZAR_ENGINE_INCLUDE_PLATFORM_ERRORS_HPP_
