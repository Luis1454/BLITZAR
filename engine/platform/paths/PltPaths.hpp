/*
 * @file engine/platform/paths/PltPaths.hpp
 * @author Luis1454
 * @project BLITZAR
 * @brief Platform abstraction interfaces for portable runtime services.
 */

#ifndef BLITZAR_ENGINE_INCLUDE_PLATFORM_PATHS_HPP_
#define BLITZAR_ENGINE_INCLUDE_PLATFORM_PATHS_HPP_
#include <ctime>
#include <string>
#include <string_view>
#include <vector>
...
#endif // BLITZAR_ENGINE_INCLUDE_PLATFORM_PATHS_HPP_
