/*
 * @file engine/platform/process/PltProcess.hpp
 * @author Luis1454
 * @project BLITZAR
 * @brief Platform abstraction interfaces for portable runtime services.
 */

#ifndef BLITZAR_ENGINE_INCLUDE_PLATFORM_PROCESS_HPP_
#define BLITZAR_ENGINE_INCLUDE_PLATFORM_PROCESS_HPP_
#include <cstdint>
#include <memory>
#include <string>
#include <vector>
...
#endif // BLITZAR_ENGINE_INCLUDE_PLATFORM_PROCESS_HPP_
