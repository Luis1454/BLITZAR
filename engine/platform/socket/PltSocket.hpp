/*
 * @file engine/platform/socket/PltSocket.hpp
 * @author Luis1454
 * @project BLITZAR
 * @brief Platform abstraction interfaces for portable runtime services.
 */

#ifndef BLITZAR_ENGINE_INCLUDE_PLATFORM_SOCKET_HPP_
#define BLITZAR_ENGINE_INCLUDE_PLATFORM_SOCKET_HPP_
#include <cstddef>
#include <cstdint>
#include <string>
...
#endif // BLITZAR_ENGINE_INCLUDE_PLATFORM_SOCKET_HPP_
