...
static void rotate3D(float x, float y, float z, float yaw, float pitch, float roll, float &outX, float &outY, float &outZ)
{
...
static void modeComponents(ViewMode mode, float x, float y, float z, float &sx, float &sy, float &depth)
{
    switch (mode) {
        case ViewMode::XY:
            sx = x;
