...
blitzar_status Context::Impl::EnsureTree(blitzar_barnes_hut::BarnesHutSettings settings) noexcept
{
...
blitzar_status Context::Impl::PrepareTree(blitzar_core::ParticleStateView particles,
...
blitzar_status Context::Impl::UploadTree(std::span<const blitzar_trees::Octree::Cell> cells,
