...
[[nodiscard]] blitzar_status UploadScalars(Buffers& buffers,
...
blitzar_status Context::Impl::EnsureBuffers(
...
blitzar_status Context::Impl::UploadFullState(blitzar_core::ParticleStateView particles) noexcept
{
...
blitzar_status Context::Impl::UploadTargetState(blitzar_core::ParticleStateView particles) noexcept
{
...
blitzar_status Context::Impl::UploadSourceState(
...
blitzar_status Context::Impl::UploadForces(blitzar_core::ForceView forces) noexcept
{
...
blitzar_status Context::Impl::QueueForceDownloads(std::size_t particle_count) noexcept
{
...
blitzar_status Context::Impl::Finish(
