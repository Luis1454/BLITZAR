...
blitzar_status Context::CheckRuntime() const noexcept
{
...
blitzar_status Context::ComputeDirect(blitzar_core::ParticleStateView particles,
...
blitzar_status Context::ComputeDirectRange(blitzar_core::ParticleStateView particles,
...
blitzar_status Context::ComputeBarnesHut(const BarnesHutComputeRequest& request) noexcept
{
    const blitzar_status runtime_status = CheckRuntime();
