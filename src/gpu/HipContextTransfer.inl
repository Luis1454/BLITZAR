...
[[nodiscard]] blitzar_status UploadScalars(HipBuffers& buffers,
...
blitzar_status HipContext::Impl::EnsureBuffers(
...
blitzar_status HipContext::Impl::UploadSourceState(
...
blitzar_status HipContext::Impl::UploadForces(blitzar_core::ForceView forces) noexcept
{
...
blitzar_status HipContext::Impl::QueueForceDownloads(std::size_t particle_count) noexcept
{
...
blitzar_status HipContext::Impl::Finish(
