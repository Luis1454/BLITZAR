...
blitzar_status GpuContext::Impl::UploadDirectInputs(blitzar_core::ParticleStateView particles,
...
blitzar_status GpuContext::Impl::ComputeDirect(blitzar_core::ParticleStateView particles,
    ...
    blitzar_solvers::ForceRange range) noexcept
{
    ...
    const blitzar_accelerator_launch::DirectLaunchRequest launch_request{addresses, particles.count,
    ...
    status = blitzar_accelerator_launch::LaunchDirect(launch_request);
