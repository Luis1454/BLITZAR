    ...
    std::size_t target_count, std::size_t source_count, std::size_t cell_count) noexcept
{
    ...
    return target_count <= maximum / sizeof(double) && source_count <= maximum / sizeof(double) &&
           cell_count <= maximum / sizeof(blitzar_accelerator_launch::GpuCell) &&
    ...
    std::size_t target_count, std::size_t source_count, std::size_t cell_count) noexcept
{
    ...
    const std::size_t cell_bytes = cell_count * sizeof(blitzar_accelerator_launch::GpuCell);
