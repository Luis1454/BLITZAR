...
blitzar_status HipContext::CheckRuntime() const noexcept
{
...
blitzar_status HipContext::ComputeBarnesHut(const BarnesHutComputeRequest& request) noexcept
{
    const blitzar_status runtime_status = CheckRuntime();
