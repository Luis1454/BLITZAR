#ifndef BLITZAR_MPI_PACKETS_MPI_PACKET_TRANSPORT_HPP
#define BLITZAR_MPI_PACKETS_MPI_PACKET_TRANSPORT_HPP
...
public:
    MpiPacketTransport(const MpiNativeSession& session, const MpiCollectives& collectives) noexcept;
...
private:
    ...
    const MpiNativeSession& session_;
