#ifndef BLITZAR_MPI_GHOST_MPI_GHOST_TRANSPORT_HPP
#define BLITZAR_MPI_GHOST_MPI_GHOST_TRANSPORT_HPP
...
public:
    MpiGhostTransport(const MpiNativeSession& session, const MpiCollectives& collectives,
