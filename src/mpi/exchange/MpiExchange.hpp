#ifndef BLITZAR_MPI_EXCHANGE_MPI_EXCHANGE_HPP
#define BLITZAR_MPI_EXCHANGE_MPI_EXCHANGE_HPP
...
public:
    MpiExchange(const MpiContext& context, const MpiDomainDecomposition& decomposition,
...
private:
    ...
    const MpiDomainDecomposition& decomposition_;
