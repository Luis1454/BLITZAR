...
blitzar_status MpiDomainPartition::AllocateBuffers(
...
void MpiDomainPartition::BuildRootKeys(
...
void MpiDomainPartition::BuildRootSplits() noexcept
{
...
blitzar_status MpiDomainPartition::BroadcastSplits(const MpiContext& context) noexcept
{
...
blitzar_status MpiDomainPartition::Initialize(blitzar_core::ParticleStateView state,
...
int MpiDomainPartition::Owner(blitzar_core::Vector3 position, std::uint64_t particle_id,
