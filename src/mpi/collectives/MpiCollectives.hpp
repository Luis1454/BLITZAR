#ifndef BLITZAR_MPI_COLLECTIVES_MPI_COLLECTIVES_HPP
#define BLITZAR_MPI_COLLECTIVES_MPI_COLLECTIVES_HPP
...
public:
    explicit MpiCollectives(const MpiNativeSession& session) noexcept;
