#include "io/md/reader/MetadataReaderJson.hpp"

#include "io/md/cursor/MetadataCursor.hpp"
#include "io/md/fields/MetadataFields.hpp"
...
[[nodiscard]] bool ReadDocumentHeader(MetadataCursor& cursor, MetadataRunInfo& info)
{
    ...
    if (!cursor.Expect("{") ||
        ...
        schema_version != MetadataManifestSchemaVersion ||
