#ifndef BLITZAR_SIMULATION_COMPOSITION_SOLVER_DISPATCH_HPP
#define BLITZAR_SIMULATION_COMPOSITION_SOLVER_DISPATCH_HPP
...
template <typename Solver> struct SolverDispatchContext final {
    blitzar_hip::Context& accelerator;
    Solver& cpu;
...
private:
    blitzar_hip::Context& accelerator_;
    Solver& cpu_;
