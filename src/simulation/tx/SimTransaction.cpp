...
SimTransaction::SimTransaction(SimTransactionState state) noexcept
...
blitzar_status SimTransaction::Prepare() noexcept
{
...
void SimTransaction::Begin() noexcept
{
...
void SimTransaction::Complete() noexcept
{
...
void SimTransaction::Commit() noexcept
{
...
void SimTransaction::Abort() noexcept
{
...
void SimTransaction::ResetSnapshots() noexcept
{
    arena_snapshot_.Clear();
    force_snapshot_.Clear();
    exchange_snapshot_.Clear();
