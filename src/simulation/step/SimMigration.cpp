...
blitzar_integration_kdk::DriftTransition Sim::MigrateAfterDrift(std::size_t rollback_particle_count,
    ...
    blitzar_integration::KdkCheckpoint& current_checkpoint) noexcept
{
    ...
    SimPacketStoreRequest migration_request{migration_buffer_, particle_state_.Arena(),
