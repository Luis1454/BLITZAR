...
[[nodiscard]] blitzar_status ResizeStage(std::size_t count, SimInputStage& stage) noexcept
{
    try {
...
void CopyParticle(
    blitzar_core::ParticleStateView input, std::size_t index, SimInputStage& stage) noexcept
{
...
blitzar_core::ParticleStateView SimInputStage::State() const noexcept
{
